...
namespace VSConsole.PowerPack_UnitTests.MyToolWindowTest
{
    ...
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new VSConsole_PowerPackPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(VSConsole_PowerPackPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
